...
object Query extends util with QueryDocEnv {
  ...
  def intro = nodes(
    div(cls := DT.Paragraph.c)(
      raw(s"""${cyby} provides several convenient ways to
      ...
      raw("""When running quick searches or combined queries, all
  ...
  def quick = section(id := UId.QuickSearchDoc)(
    h2(cls := DT.H2.c)(raw("Quick Search")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    h3(cls := DT.H3.c)(raw("Search by Compound ID")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    h3(cls := DT.H3.c)(raw("Search by CAS-Nr")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    h3(cls := DT.H3.c)(raw("Search by Regular Expression")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    h3(cls := DT.H3.c)(raw("Control Icons")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    div(cls := DT.IconList.c)(
      ...
      div(cls := DT.IconRow.c)(
        ...
        div(cls := DT.IconDesc.c)(raw("Toggles case sensitive textual search."))
      ),
    ),
  )

  def shortCuts = section(id := UId.NavSearchDoc)(
    h2(cls := DT.H2.c)(raw("Navigator Shortcuts")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
  ...
  def combined = section(id := UId.CombSearchDoc)(
    h2(cls := DT.H2.c)(raw("Combined Queries")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    h3(id := UId.SingleQueriesDoc, cls := DT.H3.c)(raw("Single Row Queries")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    h4(cls := DT.H4.c)(raw("Numeric Queries")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    h4(cls := DT.H4.c)(raw("Text Queries")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    h4(cls := DT.H4.c)(raw("Lab Inventory")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    h4(cls := DT.H4.c)(raw("Data Analysis")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    h4(cls := DT.H4.c)(raw("Data Maintenance")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    h3(id := UId.QueryManagementDoc, cls := DT.H2.c)(raw("Managing Queries")),
    div(cls := DT.Paragraph.c)(
      raw(s"""
    ...
    example(queries(storedQueriesExmpl, nodes())),
    div(cls := DT.Paragraph.c)(
      raw(s"""
  ...
  def exampleQ(ss: Node*): Node = example(ul(cls := CT.QueryList.c)(ss: _*))
