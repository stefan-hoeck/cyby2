...
object Navigator extends util {
  ...
  def doc = section(id := UId.NavigatorDoc, cls := DT.Section.c)(
    h1(cls := DT.H1.c)("Navigator: Organizing Data"),
    div(cls := DT.SectionContent.c)(
      ...
      h2(id := UId.UsersDoc, cls := DT.H2.c)("Users and their Roles"),
      div(cls := DT.Paragraph.c)(
        s"""
      ...
      div(cls := DT.DescList.c)(
        ...
        div(cls := DT.DescRow.c)(
          div(cls := DT.DescName.c)("Superuser"),
          div(cls := DT.DescContent.c)(
            s"""
        ...
        div(cls := DT.DescRow.c)(
          div(cls := DT.DescName.c)("Administrator"),
          div(cls := DT.DescContent.c)(
            s"""
      ...
      h2(id := UId.ProjectsDoc, cls := DT.H2.c)("Projects"),
      div(cls := DT.Paragraph.c)(
        s"""
      ...
      h2(id := UId.TagSupDoc, cls := DT.H2.c)(
        "Suppliers, Tags, and Storage Locations"
      ),
      div(cls := DT.Paragraph.c)(
        s"""
