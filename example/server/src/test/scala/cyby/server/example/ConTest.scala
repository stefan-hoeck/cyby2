...
class ConTest extends ConImplicits {
  ...
  val mod: S.Mod = Container[Option,Undef,Sto.Id,Sup.Id,Project.Id,Undef,Undef,Undef,Undef](None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
